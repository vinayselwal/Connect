...
//   const [isMounted, setIsMounted] = useState(true); // Initialize isMounted
...
//   // Get the message from the socket server
//   useEffect(() => {
...
//             {chats.map((chat) => (
//               <div
//                 key={chat.id} // Replace 'id' with the actual unique identifier
//                 onClick={() => {
//                   setCurrentChat(chat);
//                 }}
//               >
